...
export const metadata: Metadata = {
  title: "Privacy Policy — SavePDF"
};

const sections = [
  {
    title: "What Data We Collect",
    body: "SavePDF does not require an account and does not intentionally collect personal information from your documents."
  },
  {
  ...
  },
  {
    ...
    body: "SavePDF may use infrastructure providers for storage, processing, and service operations. AI tools use the Gemini API key you provide in your browser."
  },
  {
    title: "Contact",
